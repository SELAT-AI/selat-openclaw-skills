...
| [`perplexity-search`](skills/perplexity-search/SKILL.md) | Grounded web search & research via Perplexity — ranked results with page content + source URLs for a cited answer, keyless (~$0.011/search — the quoted price, markup included) | $0.03 |
